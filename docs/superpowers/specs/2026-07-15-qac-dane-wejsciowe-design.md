...
| profil_zimowy_A | zima | CET | +1 h |
| profil_zimowy_B | zima | CET | +1 h |
...
```json
{
  ...
  "dane_wejsciowe": {
    "avatar_id": "profil_zimowy_A",
    "czas_lokalny": { "rok": 1958, "miesiac": 12, "dzien": 3,
                      "godzina": 1, "minuta": 10, "sekunda": 0 },
    "strefa": "Europe/Warsaw",
    "obserwator": { "dlugosc_geo": 18.6466, "szerokosc_geo": 54.3520,
                    "wysokosc_npm_m": 6 },
...
Plan: `andrzej_bogacki`, `profil_zimowy_B`, `profil_zimowy_A` wprowadzić ponownie przez
