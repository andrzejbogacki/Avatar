...
test('profil: pełny przebieg z buforem — schemat, stemple, zapis przez bramkę 9b', async () => {
    ...
    assert.equal(profil.naglowek.avatar_id, 'avatar_testowy');
    ...
    assert.equal(path.basename(sciezka), 'avatar_testowy.json');
...
// --- Sekcja niepewności (osie w profilu + niepewnosc dla przybliżonych) ---
