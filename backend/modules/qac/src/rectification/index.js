...
const { bramkaUczciwosci } = require('./bramka_uczciwosci');
...
module.exports = { zlecRektyfikacje, statusZadania, KolejkaZadan, czuloscOsi, alarmCzulosci, polaWOknie, sekcjaNiepewnosci, bramkaUczciwosci };
