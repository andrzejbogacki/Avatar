...
- **Walidacje i warunki brzegowe:**
  ...
  - Bezpiecznik ciszy: 2 godziny, kanon ADR-011 2.8, stała w `config/`. Osiągnięcie progu wywołuje skutek — upływ równy dwóm godzinom już gasi, upływ równy końcowi okna już wygasza zsunięcie. Kanon, nie wniosek z analogii; konwencja odwrotna niż przy granicy planszy (2.3), bo tam rozstrzyga się przynależność do figury, a tu upływ terminu.
...
- **Historia zmian:**
  ...
  - 2026-09-08 — rozstrzygnięcie Suwerena: osiągnięcie progu czasowego wywołuje skutek. Punkt otwarty ADR-011 O12 zamknięty, reguła wpisana do punktu 2.8, wariant odrzucony do alternatyw. Zachowanie kodu bez zmian — reguła już w nim stała; zmieniło się jej źródło: kanon zamiast interpretacji logicznej. Backend 318 testów, 317 pass, 0 fail, 1 skip.
