...
Dla urodzeń w czasie zimowym (CET, `andrzej_bogacki`, `profil_zimowy_A`,
`profil_zimowy_B`) błąd wynosi +1 h; dla urodzenia w czasie letnim (CEST,
...
## Konsekwencje
- Cztery istniejące profile (`andrzej_bogacki`, `profil_zimowy_A`,
  `profil_zimowy_B`, `test_test`) wymagają ponownego wygenerowania z
